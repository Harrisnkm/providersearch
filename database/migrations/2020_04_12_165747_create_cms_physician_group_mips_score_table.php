...
class CreateCmsPhysicianGroupMipsScoreTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cms_physician_group_mips_score', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cms_physician_group_mips_score');
    }
}
